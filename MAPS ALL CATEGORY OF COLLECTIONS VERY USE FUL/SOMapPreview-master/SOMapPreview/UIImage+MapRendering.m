...
- (UIImage *)drawOverlay:(MKPolyline *)polyline snapshot:(MKMapSnapshot *)snap color:(UIColor *)color
{
	...
	return [self drawLineWithPoints:points pointCount:polyline.pointCount rect:rect color:color];
}

- (UIImage *)drawLineWithPoints:(CGPoint *)coordSet
